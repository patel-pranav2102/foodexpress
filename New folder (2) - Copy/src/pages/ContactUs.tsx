  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden h-72 md:h-96">
        <img 
          src="https://images.unsplash.com/photo-1584543515885-b8981dbf0b5d?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?w=1200&h=600&fit=crop"
          alt="Contact Us Hero"
