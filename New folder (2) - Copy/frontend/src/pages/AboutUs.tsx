  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden h-72 md:h-96">
        <img 
          src="https://images.unsplash.com/photo-1518481612222-68bbe828ecd1?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?w=1200&h=600&fit=crop"
          alt="About Hero"
      ...
      <section className="container mx-auto px-4 md:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <img 
              src="https://images.pexels.com/photos/1410235/pexels-photo-1410235.jpeg?w=600&h=600&fit=crop"
              alt="Our Mission"
